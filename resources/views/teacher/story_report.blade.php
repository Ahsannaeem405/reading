<div class="row ">
    <div class="col-lg-12 mt-5 p-0">
        <div class="text p-3"
            ...
            <span class="d-block text-white ml-lg-5" style="font-size: 22px">({{$reading->user->name}}) Story
                        ...
                        <div class="col-lg-8 p-4 ">
                            <div class="q_1 ">
                                ...
                                <span><input type="hidden" value="{{$question->question}}"
                                        name="question[]">{{$question->question}}?[{{$question->catgname->name}}]</span>
                                ...
                                <div class="bottom mt-5 ml-lg-4">
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                            ...
                                            <div style="@if($option->user_answer=='yes' && $option->correct=='no' ) background-color: orangered @else background-color: #b8e8c3 @endif"
                                                class="col-lg-6  mb-3 col-12">
                                                <input disabled type="radio" @if($option->user_answer=='yes')
                                                checked @endif name="check_{{$count}}" value="{{$count2++}}"
                                                required class="custom-checkbox" style=" transform: scale(2);">
                                                <span class="ml-2" style="color: #5c5cb1;font-size: 20px">
