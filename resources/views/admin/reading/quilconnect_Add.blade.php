            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{url('admin/readings/quilconnect/save')}}" method="post" enctype="multipart/form-data"  class="steps-validation wizard-circle">
                             @csrf
                                <!-- Step 1 -->
                                        ...
                                        <div class="row" id="row_1">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" id="q1" name="sentence1[]">
                                                </div>
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" id="q2" name="sentence2[]">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="answer[]" cols="20" id="longdesc" rows="4" class="form-control required"></textarea>
                                                </div>
        ...
        $(document).ready(function(){
            ...
            $("#add_ques").click(function(){
             ...
             var   count2=5;
                ...
                op+='<label for="proposalTitle3">First Sentence</label>';
                ...
                op+='<div class="form-group">';
                op+='<label for="proposalTitle3">Second Sentence</label>';
