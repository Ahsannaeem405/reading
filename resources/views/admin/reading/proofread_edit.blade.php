            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Proofread </h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{url('admin/readings/proofread/update/'.$reading->id.'')}}" method="post" enctype="multipart/form-data"  class="steps-validation wizard-circle">
                             @csrf
                                <!-- Step 1 -->
                                        ...
                                        <div class="row" id="row_0">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="content" cols="20" id="longdesc" rows="10" class="form-control required">{{ $reading->proofdetail->content }}</textarea>
                                                </div>
                                            </div>
                                        </div>
