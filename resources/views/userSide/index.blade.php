...
" data-animation="fadeInLeft" data-delay=".4s">Join us Student to learn.</h1>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                            ...
                            <div class="col-xl-6 col-lg-5">
                                <div class="hero-man d-none d-lg-block f-right" data-animation="jello" data-delay=".4s">
                                    <img src="{{asset('userSide/assets/img/hero/heroman.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-sm-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        ...
                        <div class="section-tittle text-center mb-70">
                            <span>Popular Online Lessons</span>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a  href="#">Reading</a></h5>
                                <p>Reading Detail here.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a  href="#">vocabulary</a></h5>
                                <p>vocabulary Detail here.</p>
                                <a  href="#" class="read-more1">Read More ></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="single-counter text-center">
                                        ...
                                        <span class="counter color-blue">2050</span>
                                        <p class="color-blue">+ Questions</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <!-- Counter Up -->
                                    <div class="single-counter text-center">
                                        ...
                                        <p class="color-green">+ Students</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <!-- Counter Up -->
                                    <div class="single-counter text-center">
                                        ...
                                        <span class="counter color-red">1350</span>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="{{asset('userSide/assets/img/gallery/popular_sub1.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="{{asset('userSide/assets/img/gallery/popular_sub2.png')}}" alt="">
                            </div>
                            <div class="course-caption">
                                <div class="course-cap-top">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="{{asset('userSide/assets/img/gallery/popular_sub3.png')}}" alt="">
                            </div>
                            <div class="course-caption">
                                <div class="course-cap-top">
        ...
        <!-- Popular Course End -->
        <!--? Team Ara Start -->
        <div class="team-area pt-160 pb-160 section-bg" data-background="{{asset('userSide/assets/img/gallery/section_bg02.png')}}">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        <!-- Section Tittle -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('userSide/assets/img/gallery/team1.png')}}" alt="">
                                <!-- Blog Social -->
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('userSide/assets/img/gallery/team2.png')}}" alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('userSide/assets/img/gallery/team3.png')}}" alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('userSide/assets/img/gallery/team4.png')}}" alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <ul>
                                <li><span class="flaticon-business"></span> Best Learning stage</li>
                                <li><span class="flaticon-communications-1"></span> Best Teachers</li>
                                <li><span class="flaticon-graduated"></span> Skills Improvement</li>
                                <li><span class="flaticon-tools-and-utensils"></span> Question/Answer</li>
                            </ul>
...
" src="{{asset('userSide/assets/img/gallery/about2.png')}}" alt="">
                            </div>
        ...
        <!-- About Law End-->
        <!--? Testimonial Start -->
        <div class="testimonial-area fix pt-180 pb-180 section-bg" data-background="{{asset('userSide/assets/img/gallery/section_bg03.png')}}">
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <div class="h1-testimonial-active">
                            ...
                            <div class="single-testimonial pt-65">
                                ...
                                <div class="testimonial-icon mb-45">
                                    <img src="{{asset('userSide/assets/img/gallery/testimonial.png')}}" class="ani-btn " alt="">
                                </div>
                                <!-- Testimonial Content -->
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="{{asset('userSide/assets/img/gallery/home-blog1.png')}}" alt="">
                                    <!-- Blog date -->
                                ...
                                <div class="blog-cap">
                                    <p>Story 1</p>
                                    <h3><a href="#">Story Short detail</a></h3>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="{{asset('userSide/assets/img/gallery/home-blog2.png')}}" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
