                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                            ...
                                            <div style="@if($option->user_answer=='yes' && $option->correct=='no' ) background-color: orangered @else background-color: #b8e8c3 @endif"
                                                ...
                                                <input disabled type="radio" @if($option->user_answer=='yes') checked
                                                @endif name="check_{{$count}}" value="{{$count2++}}" required
                                                class="custom-checkbox" style=" transform: scale(2);">
                                                <span class="ml-2" style="color: #5c5cb1;font-size: 20px"> <input
