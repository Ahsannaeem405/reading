    ...
    <main style="background-color: #c9faf3">
        <div class="container">
            ...
            <div class="row ">
                <div class="col-lg-12 mt-5 p-0" >
                    <div class="text p-3" style="background-color: #46a7b8;border-radius: 25px 25px 0px 0px;border-bottom: 1px solid #31b48f">
                        <span class="d-block text-white ml-lg-5" style="font-size: 22px">({{$reading->user->name}}) Quil connect     [{{$reading->story_title}}]</span>
                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-sm-12">
                                                            ...
                                                            <p>{{$question->user_answer}}. 
                                                                <span style="padding: 1px; color: white; @if($question->user_answer == $question->answer) background: green; @else background: red; @endif" class="px-1"><i class="fa @if($question->user_answer == $question->answer) fa-check @else fa-times @endif"></i></span>
                                                            </p>
