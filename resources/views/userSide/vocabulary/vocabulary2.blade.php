                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                            ...
                                            <div style="background-color: #b8e8c3" class="col-lg-6  mb-3 col-12">
                                                <input type="checkbox" class="custom-checkbox" style="  transform: scale(2);">
                                                <span class="ml-2" style="color: #5c5cb1;font-size: 20px" >XYZ Sentance </span>
                                            </div>
                                            <div style="background-color: #b8e8c3" class="col-lg-6  mb-3 col-12">
                                                <input type="checkbox" class="custom-checkbox" style="  transform: scale(2);">
                                                <span class="ml-2" style="color: #5c5cb1;font-size: 20px" >XYZ Sentance </span>
                ...
                <div class="col-lg-12">
                    <div class="buttons" style="position:absolute;bottom: 0px;width: 100%">
                        ...
                        <div class="right-btn" style="display: inline-block;float: right">
                            <a href="{{url('vocabulary/step3')}}"><input type="button" class="btn btn-success" style="border-radius: 0px 0px 25px 0px;background: #35922d !important; "  value="GO ON">
                            </a>
                        </div>
                    </div>
